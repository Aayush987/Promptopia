  ...
  return (
    ...
    {session?.user.id === post.creator._id && pathName === '/profile' && (
      <div className="mt-5 flex-center gap-4 border-t border-gray-400 pt-3">
        <p className="font-inter green_gradient text-sm cursor-pointer" onClick={handleEdit}>
          Edit
        </p>
        <p className="font-inter orange_gradient text-sm cursor-pointer" onClick={handleDelete}>
          Delete
        </p>
      </div>
    )}
